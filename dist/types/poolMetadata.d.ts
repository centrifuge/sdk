...
export type MerkleProofPolicyInput = Pick<MerkleProofPolicy, 'target' | 'decoder' | 'action' | 'selector' | 'inputs'> & {
    valueNonZero?: boolean;
};
export type PoolMetadata = {
    ...
    merkleProofManager?: Record<string, Record<HexString, {
    ...
    withdrawManagers?: Record<string, {
