export default [
  ...
  'function setQueue(uint64 poolId, bytes16 scId, bool enabled) payable',
  ...
  'function updateVault(uint64 poolId, bytes16 scId, uint128 assetId, bytes32 vaultOrFactory, uint8 kind) payable',
