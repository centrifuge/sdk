export default [
  ...
  'function transferTrancheTokens(address vault, uint16 chainId, bytes32 recipient, uint128 amount) payable',
  'function transferTrancheTokens(address vault, uint16 chainId, address recipient, uint128 amount) payable',
